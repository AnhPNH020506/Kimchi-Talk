...
public class Service : IService
{
    ...
    public async Task<Response.GetVocabulariesResponse?> GetVocabularyById(Guid userId, Guid vocabularyId)
    {
        ...
        var userVocabulary = await _dbContext.UserVocabulary
            .Where(u => u.VocabularyId == vocabularyId && u.UserId == userId).FirstOrDefaultAsync();
    ...
    public async Task MarkVocabularyAsLearned(Guid userId, Guid vocabularyId)
    {
        ...
        var userVocabulary = await _dbContext.UserVocabulary
            .Where(u => u.UserId == userId && u.VocabularyId == vocabularyId).FirstOrDefaultAsync();
    ...
    public async Task UpdateVocabulary(Guid adminId, Guid vocabularyId, Request.VocabularyRequest request)
    {
        ...
        vocabulary.Type = request.Type;
        vocabulary.MeaningVietNamese = request.MeaningVietnamese;
